...
export function useTeams() {
            ...
            if (data.teams) {
                ...
                if (!initialized) {
                    ...
                    if (activeTeamData.activeTeamId && data.teams.length > 0) {
                        const activeTeam = data.teams.find((t) => t.id === activeTeamData.activeTeamId);
                        if (activeTeam) {
    ...
    const handleCreateTeam = async (setMessage) => {
        try {
    ...
    const handleJoinTeam = async (setMessage) => {
        try {
    ...
    const handleTeamSearch = async (setMessage) => {
        try {
    ...
    const handleDeleteTeam = async (teamId, setMessage) => {
    ...
    const handleUpdateTeam = async (teamId, updates, setMessage) => {
        try {
    ...
    const handleAddMember = async (setMessage) => {
    ...
    const handleRemoveMember = async (memberId, setMessage) => {
