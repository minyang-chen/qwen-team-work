...
export function TeamApp() {
    ...
    if (view === 'workspace' && isAuthenticated) {
        return _jsx(TeamDashboard, { onTeamSelected: () => setView('select'), onLogout: handleLogout });
    }
    if (view === 'select' && isAuthenticated) {
        return (_jsx(TeamSelect, { onTeamSelected: handleTeamSelected, onLogout: handleLogout }));
    }
    if (view === 'signup') {
        return (_jsx(TeamSignup, { onSuccess: handleSignupSuccess, onSwitchToLogin: handleSwitchToLogin }));
    }
    return (_jsx(TeamLogin, { onSuccess: handleLoginSuccess, onSwitchToSignup: handleSwitchToSignup }));
}
