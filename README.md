...
[Installation](#installation) • [Quick Start](#quick-start) • [Features](#key-features) • [ACP Architecture](#acp-architecture) • [Documentation](./docs/) • [Contributing](./CONTRIBUTING.md)
...
## 🚀 ACP Architecture (NEW)

Qwen Code now features a complete **Agent Communication Protocol (ACP)** implementation for scalable, distributed AI agent communication:

### Key Features
- **WebSocket-based Protocol**: Real-time bidirectional communication
- **Agent Discovery**: Configuration-based discovery with health monitoring
- **Session Management**: Multi-user isolation with automatic cleanup
- **MongoDB Integration**: Vector search support for enhanced AI capabilities
...
📖 **[Complete ACP Documentation](./docs/acp/)**
...
- **ACP Integration** - Distributed agent communication with real-time protocol support
...
- **[ACP Implementation Status](./docs/acp/ACP_IMPLEMENTATION_STATUS.md)** - Complete implementation overview
- **[ACP Deployment Guide](./docs/acp/ACP_DEPLOYMENT_GUIDE.md)** - Production deployment instructions  
- **[Production Checklist](./docs/acp/PRODUCTION_CHECKLIST.md)** - Pre-deployment validation
- **[ACP Design Document](./docs/acp/ACP_DECOUPLING_DESIGN.md)** - Architecture and design decisions
